// Login Component for PMC System
"use client";
...
export default function Login() {
  ...
  const initializeSampleData = async () => {
    try {
      ...
      setEmail('admin@pmc.com');
      setPassword('password');
      setError('Sample data initialized. Use admin@pmc.com to login.');
    } catch {
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Local-First Architecture & Project Management
          </p>
        </div>
